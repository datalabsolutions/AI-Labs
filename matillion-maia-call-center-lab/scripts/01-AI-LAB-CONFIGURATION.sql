...
GRANT ALL PRIVILEGES ON SCHEMA CALL_CENTER_ANALYTICS_DB.EXTRACT TO ROLE APP_MATILLION_ROLE;
GRANT ALL PRIVILEGES ON SCHEMA CALL_CENTER_ANALYTICS_DB.STAGE TO ROLE APP_MATILLION_ROLE;
GRANT ALL PRIVILEGES ON SCHEMA CALL_CENTER_ANALYTICS_DB.DWH TO ROLE APP_MATILLION_ROLE;


-- Table privileges (all current + future tables)
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.EXTRACT TO ROLE APP_MATILLION_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.STAGE TO ROLE APP_MATILLION_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON ALL TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.DWH TO ROLE APP_MATILLION_ROLE;

GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.EXTRACT TO ROLE APP_MATILLION_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.STAGE TO ROLE APP_MATILLION_ROLE;
GRANT SELECT, INSERT, UPDATE, DELETE ON FUTURE TABLES IN SCHEMA CALL_CENTER_ANALYTICS_DB.DWH TO ROLE APP_MATILLION_ROLE;
