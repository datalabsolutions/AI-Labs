...
--------------------------------------------------------------------------
-- Step 2: Ensure target table exists
--------------------------------------------------------------------------
-- Creates a table to store aggregated AI outputs per call.
--------------------------------------------------------------------------
...
(
    ...
    ISSUE_RESOLVED VARCHAR,
    SUMMARY_ITEMS VARCHAR,
    ACTION_ITEMS VARCHAR
);

--------------------------------------------------------------------------
-- Step 3: Preview aggregated results for a single call
--------------------------------------------------------------------------
-- Highlights:
...
--------------------------------------------------------------------------
-- Step 4: Persist aggregated results across the dataset
--------------------------------------------------------------------------
-- Highlights:
...
-- Differences: Removes the single-call filter; writes results for reuse.
--------------------------------------------------------------------------

TRUNCATE TABLE CALL_CENTER_DB.STAGE.TRANSCRIBE_AUDIO_FILES_ANALYSIS;

INSERT INTO CALL_CENTER_DB.STAGE.TRANSCRIBE_AUDIO_FILES_ANALYSIS
WITH CTE_RESULTS
AS
(
    SELECT
...
--------------------------------------------------------------------------
-- Step 5: Preview persisted analysis
--------------------------------------------------------------------------
